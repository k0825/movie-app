export const requests = {
  ...
  feactActionMovies: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_genres=28`,
  feactComedyMovies: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_genres=35`,
  feactHorrorMovies: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_genres=27`,
